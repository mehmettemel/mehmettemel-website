...
export const metadata = {
  title: 'About - Mehmet Temel | Travel & Food Blogger',
  description:
    'Learn more about Mehmet Temel, a passionate traveler and food enthusiast sharing authentic experiences from around the world.',
}
