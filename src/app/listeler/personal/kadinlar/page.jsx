...
export const metadata = {
  title: 'Kadınlar',
  description: 'Kadınlar ve ilişkiler üzerine notlar',
}
...
export default async function KadinlarPage() {
  ...
  // Read markdown file
  const filePath = join(process.cwd(), 'data', 'personal', 'kadinlar.md')
    ...
    <Container>
      <div className="mx-auto max-w-7xl py-8 sm:py-12">
        {Object.keys(categories).length === 0 ? (
          ...
          <KendimeNotlarContent categories={categories} title="Kadınlar" />
        )}
      </div>
    </Container>
  )
