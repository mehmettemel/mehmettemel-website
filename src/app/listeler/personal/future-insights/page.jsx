...
import { categories } from '@/data/personal/future-insights'

export const metadata = { title: 'Future Insights | Mehmet Temel' }
  ...
  return (
    <Container>
      <div className="mx-auto max-w-7xl py-8 sm:py-12">
        <PersonalContent categories={categories} title="Future Insights" />
      </div>
    </Container>
  )
}
