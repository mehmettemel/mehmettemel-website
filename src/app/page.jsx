...
export const metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mehmet Temel - Front End Engineer & Travel Enthusiast',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Mehmet Temel - Front End Engineer & Travel Enthusiast',
    description:
      'Front End Engineer specializing in React, Vue.js, and e-commerce development. Based in Adana, Turkey, but always traveling.',
    images: ['/og-image.jpg'],
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex items-center">
        ...
        <Button disabled type="submit" className="ml-4 flex-none">
          Join
        </Button>
      </div>
    </form>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Mehmet Temel, a Front End Engineer based in Adana, Turkey,
            but constantly on the move. I specialize in React, Vue.js, and
            e-commerce development. When I&apos;m not coding, you&apos;ll find
            me exploring new destinations, discovering local cuisines, and
            sharing my travel and food adventures.
          </p>
