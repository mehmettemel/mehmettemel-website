export const title = 'Kendime Notlar'
...
export const categories = {
  ...
  'İletişim Yetenekleri': {
    label: 'İletişim Yetenekleri',
    items: [
      'iletişim yeteneklerine yatırım yap.ne kadar eğitimli, tecrübeli, bilgili ve çalışkan olursan ol eğer üst düzey sosyal becerilerin yoksa iş hayatında da özel hayatında da bir yerlere varman çok zor.karşındaki kişiyi dikkatli bir şekilde dinle ve anladığını göster.göz teması kur, yüz ifadeni kontrol et ve uygun jestler kullan.bu konularda algı yönetimi, beden dili, diksiyon, kişisel imaj ve koçluk gibi eğitimler alabilirsin.iletişim kurmayı öğrenin. çoğu insan diğer insanlarla konuşurken onları anlamak isteyerek dinlemez ve sadece verecekleri cevabı düşünerek dinlerler. karşınızdaki insanları gerçekten anlamayı başarabilirseniz bu size büyük bir güç kazandıracaktır.',
      'you never really know who that champion is going to be for you. Today\'s intern could be tomorrow\'s CEO. So, treat everyone like they\'re the damn CEO.And let\'s talk about time. Rome wasn\'t built in a day, and neither are meaningful relationships. You can\'t expect to meet someone at an event and instantly become BFFs. Relationships, the real ones, take time. They\'re built on shared experiences, trust, and mutual respect. So, if you\'re hopping from one event to another, looking for that magic connection, slow the hell down. Take a breath. And focus on building one relationship at a time. Do follow-ups if you had a great conversation with someone, or continue it over lunch.',
      'Bir şeyi istiyorsanız once onu karşıya verin. verirseniz size daha çok gelir. karşıdakinin size yolda selam vermesini istiyorsanız önce siz vererek başlatın.saygı görmek istiyorsanız saygı verin',
      'biri senden talepte bulunmadıkça kendiliğinden ona yardım etme.zira kıymeti anlaşılmıyor.karşılıksız yaptığınız her şey için bir gün gelir "yapmasaydın" tepkisini alırsınız.',
      ...
      'Most of the wealthiest people I\'ve met who reach billionaire status are natural networkers, who are driven by a genuine desire to serve and help others.Most of the millionaires I\'ve met who remain stuck at 7 and 8 figures are talented, but they isolate themselves rather than building networks so the only doors that open are the ones they open themselves.By being a good and helpful human with the intention of serving others, you create opportunities. -Julian Petroulas',
  ...
  'Kişisel Gelişim': {
    ...
    items: [
      'Evet,diye düşündüm.Özgüven.Bir adamın özkaynaktan,nakitten daha fazla ihtiyacı olan şey. -Phil Knight',
      'rejection is far better than regret',
      'life does not wait for you to be okay.',
      'Always wake up early because nobody distract your attention.Eat your frog first thing in the morning.Make your most difficult task early morning and then rest of the day getting better.',
      'Mutluluğa giden tek bir yol vardır; o da irademiz dışındaki şeyler yüzünden kaygılanmayı bırakmaktır.',
      'Eğer başarılı görünmek istiyorsanız, tecrübe edinin: yeni yerler görün, extreme sporlar yapın, yeni bir girişim kurun.insanlarla konuşmak bir sürü dost edinmek sizi daha mutlu bir insan yapar. fakat insanlar sizin şimdiye kadar kaç ev aldığınızı mı dinler yoksa yabanda geçirdiğiniz bir yılı mı?(örnekler:toplu yürüyüş etkinlikleri, yoga)',
      '"Never complain, never explain" - Benjamin Disraeli. ı learned this from robert greene. complain things make your mindset weak. just do your things. do not explain it looks you weak.',
      'Bu hayatta ne yaşarsanız yaşayın, ancak sakın mağdur psikolojisine girmeyin. Zira incitilmiş ve yaralı olma hissi enerjinizi düşürür ve karizmanızı zedeler. Bilakis "ben öyle saygın ve güçlü biriyim ki ne zorlukları aştım" deyin. Bu yeni çerçeve anında duruşunuzu yükseltecektir.',
      'Confidence isn\'t "I know they\'ll like me", it\'s "I\'m okay if they don\'t".',
      'The modern superpower is your ability to focus in a world of distractions.clarity of how to achieve your purpose is the main thing.',
      'Hayat cesurlara cömert.Ölümün olduğu bir dünyada tüm riskler komik kalıyor.',
      'atılgan olmak temkinli olmaktan daha iyidir;çünkü talih dişidir ve ona hükmetmek isteniyorsa onu dövmek ve zorlamak gerekir.Talihin soğuk davrananlardan çok,bu kişilere kendini teslim ettiği görülür;gene bu yüzden,kadın olarak hep gençlerin dostudur,çünkü gençler daha az temkinli, daha saldırgandırlar ve daha pervasızca hükmedeler ona.',
      'yetenek de zekâ da harekete geçebilmek için cesaretten gelen o ilk emri bekliyor. cesaret, abartılmayı hak ediyor.',
      'Cancellations, delays, last-minute curveballs — elite men adapt gracefully. "No worries, let\'s reschedule" isn\'t weakness — it\'s power.',
    ]
  },
  'Hayat Felsefeleri': {
    label: 'Hayat Felsefeleri',
    items: [
      'Ormanda yol ikiye ayrıldı ve ben hep daha az kullanılanı seçtim.bu hayatımdaki tüm farkı yarattı.',
      'Yaptığın şeyler için pişmanlığın bir gün mutlaka geçer ama yapmadığın şeyler için asla',
      'Mutluyken söz, kızgınken cevap, üzgünken karar vermeyin. Aklınızda bulunsun.',
      'Hayatlarında bir seçenek olduğunuz kişileri, kendi hayatınızda bir zorunluluk haline getirmeyin.',
      'Never cheap out on anything that connects you to the ground. Beds, tires, shoes, etc.',
