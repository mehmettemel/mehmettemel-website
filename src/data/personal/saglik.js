...
export const categories = {
  ...
  'Mutfak': {
    ...
    items: [
      ...
      { text: 'Üzerinde "Katkı Maddesi Olarak Nitrat Eklenmemiştir" (No Nitrates Added) yazan şarküteri ürünleri (salam, sosis, füme et vb.) aldığınızda içindekiler kısmında kereviz suyu (celery juice) veya kereviz tozu arayın. Kereviz tarlaları yüksek azotlu gübrelerle yoğun şekilde işlenir; bu kereviz suyu doğal bir bileşen (sebze suyu) olarak kabul edilir ama içi tamamen nitrat doludur. "Doğal/Organik" etiketiyle satılan nitratsız şarküteri ürünleri, aslında kereviz suyu kullanılarak sentetik muadilleriyle tamamen aynı kimyasal işleme maruz bırakılmaktadır.', subItems: [] },
