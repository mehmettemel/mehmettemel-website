...
export const categories = {
  ...
  'Ağız, Diş ve Boğaz Sağlığı': {
    ...
    items: [
      ...
      { text: 'Sıra önemli: 1) Dil kazıyıcı, 2) Oil pulling, 3) Ağzı su ile temizle, 4) Dişleri fırçala, 5) Su iç.', subItems: [] },
      { text: 'En pratik ve etkili kombinasyon: Akşamları damak fırçalama, düzenli diş fırçası değiştirme, diş fırçasını tuvalette tutmama ve düzenli sirkede bekletme.', subItems: [] },
      { text: 'Tuzlu ılık su gargarası: İyotsuz deniz tuzu veya kaya tuzu + sodyum bikarbonat.', subItems: [] },
      { text: 'Eczaneden "İngiliz Karbonatı" (Sodyum Bikarbonat) olarak alırsanız daha saf bir içerik elde etmiş olursunuz. Aktarlarda veya marketlerde satılanlarla arasında saflık farkı olabilir. Bu karışımı hazırlarken suyun "ılık" olması, karbonatın tam çözünmesi için kritiktir.', subItems: [] },
      { text: 'Odanın nemlendirilmesi.', subItems: [] },
      { text: 'D vitamini kontrolü ve magnezyum kontrolü.', subItems: [] },
      { text: 'İdeal gece rutini: Dişleri fırçala (ve damağı/dili unutma). Diş ipi kullan (diş aralarındaki bakterileri çıkar). Ilık tuzlu + karbonatlı su ile gargara yap (boğazın derinlerine ulaşması için kafayı iyice arkaya atıp "garrrr" sesi çıkararak yapın). Tükür ve bırak (üzerine su içmeyin veya ağzınızı durulamayın).', subItems: [] },
      { text: 'Diş fırçasını değiştirmek: Antibiyotik tedavisine başladıktan 3 gün sonra diş fırçanızı mutlaka yenisiyle değiştirin (fırçadaki bakterilerin sizi tekrar enfekte etmesini önlemek için).', subItems: [] },
      { text: 'Düzenli tuzlu su gargarası: Sadece hasta olduğunuzda değil, günlük rutinde (özellikle kalabalık ortamlardan sonra) ılık tuzlu su ile boğazı temizlemek.', subItems: [] },
      { text: 'Hava nemlendirici (humidifier) kullanmak: Yatak odasındaki havanın kurumasını engelleyerek boğaz dokusunun tahriş olmasını ve mikroplara açık hale gelmesini önlemek.', subItems: [] },
      { text: 'D vitamini ve magnezyum düzeylerini kontrol etmek: Bağışıklık sisteminin bu enfeksiyonlarla savaşabilmesi için bu değerleri yüksek tutmak.', subItems: [] },
      { text: 'Şeker ve süt ürünlerini sınırlamak: Enfeksiyonun başladığını hissettiğiniz an bakterileri besleyen şekeri ve mukoza artıran süt ürünlerini kesmek.', subItems: [] },
      { text: 'Kişisel eşyaları tamamen ayırmak: Bardak, çatal, kaşık ve havlu gibi eşyaların paylaşımını sıfıra indirmek.', subItems: [] },
