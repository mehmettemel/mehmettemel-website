export const title = 'Daily Routines'
...
export const routineList = [
  {
    ...
    children: [
      {
        id: 'sabah-1',
        label: 'Uyanır uyanmaz ilk 30 dakikada güneş ışığı almak',
      ...
      { id: 'sabah-5', label: 'Çiğ havuç ye' },
      { id: 'sabah-4', label: 'Daima modunu yüksek ve olumlu tut. Negatif şeyleri zihninde NLP ile soldur.' },
    ],
  },
]
