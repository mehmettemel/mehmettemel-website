...
export const russianPhrases = [
  ...
  { id: 323, tab: 'kafe', russian: 'молоко',     pronunciation: 'malako',    turkish: 'süt',            english: 'milk' },
  { id: 324, tab: 'kafe', russian: 'сок',        pronunciation: 'sok',       turkish: 'meyve suyu',     english: 'juice' },
  { id: 325, tab: 'kafe', russian: 'кола',       pronunciation: 'kola',      turkish: 'kola',           english: 'cola' },
  { id: 326, tab: 'kafe', russian: 'вино',       pronunciation: 'vino',      turkish: 'şarap',          english: 'wine' },
  { id: 327, tab: 'kafe', russian: 'пиво',       pronunciation: 'pivo',      turkish: 'bira',           english: 'beer' },
  { id: 328, tab: 'kafe', russian: 'мёд',        pronunciation: 'myod',      turkish: 'bal',            english: 'honey' },
  { id: 329, tab: 'kafe', russian: 'сыр',        pronunciation: 'sır',       turkish: 'peynir',         english: 'cheese' },
  { id: 330, tab: 'kafe', russian: 'яйца',       pronunciation: 'yaytsa',    turkish: 'yumurta',        english: 'eggs' },
  { id: 331, tab: 'kafe', russian: 'масло',      pronunciation: 'masla',     turkish: 'tereyağı',       english: 'butter' },
  { id: 332, tab: 'kafe', russian: 'колбаса',    pronunciation: 'kalbasa',   turkish: 'sosis/salam',    english: 'sausage' },
  { id: 333, tab: 'kafe', russian: 'бутерброд',  pronunciation: 'buterbrod', turkish: 'sandviç',        english: 'sandwich' },
  { id: 334, tab: 'kafe', russian: 'суп',        pronunciation: 'sup',       turkish: 'çorba',          english: 'soup' },
  { id: 335, tab: 'kafe', russian: 'салат',      pronunciation: 'salat',     turkish: 'salata',         english: 'salad' },
  { id: 336, tab: 'kafe', russian: 'рис',        pronunciation: 'ris',       turkish: 'pirinç',         english: 'rice' },
  { id: 337, tab: 'kafe', russian: 'лапша',      pronunciation: 'lapsha',    turkish: 'makarna/noodle', english: 'noodles' },
  { id: 338, tab: 'kafe', russian: 'картошка',   pronunciation: 'kartoška',  turkish: 'patates',        english: 'potato' },
  { id: 339, tab: 'kafe', russian: 'курица',     pronunciation: 'kuritsa',   turkish: 'tavuk',          english: 'chicken' },
  { id: 340, tab: 'kafe', russian: 'мясо',       pronunciation: 'myaso',     turkish: 'et',             english: 'meat' },
  { id: 341, tab: 'kafe', russian: 'рыба',       pronunciation: 'rıba',      turkish: 'balık',          english: 'fish' },
  { id: 342, tab: 'kafe', russian: 'пельмени',   pronunciation: 'pelmeni',   turkish: 'pelmeni (mantı)',english: 'dumplings' },
  { id: 343, tab: 'kafe', russian: 'торт',       pronunciation: 'tort',      turkish: 'pasta/kek',      english: 'cake' },
  { id: 344, tab: 'kafe', russian: 'шоколад',    pronunciation: 'shokalad',  turkish: 'çikolata',       english: 'chocolate' },
  { id: 345, tab: 'kafe', russian: 'конфеты',    pronunciation: 'kanfetı',   turkish: 'şeker/bonbon',   english: 'candy' },
  { id: 346, tab: 'kafe', russian: 'фрукты',     pronunciation: 'fruktı',    turkish: 'meyveler',       english: 'fruits' },
  { id: 347, tab: 'kafe', russian: 'овощи',      pronunciation: 'avaşchi',   turkish: 'sebzeler',       english: 'vegetables' },
  ...
  { id: 348, tab: 'temel', russian: 'Как погода?',               pronunciation: 'Kak pagoda?',                     turkish: 'Hava nasıl?',                         english: 'How is the weather?' },
  { id: 349, tab: 'temel', russian: 'Где ты?',                  pronunciation: 'Gde tı?',                         turkish: 'Neredesin?',                          english: 'Where are you?' },
  { id: 350, tab: 'temel', russian: 'Я дома',                   pronunciation: 'Ya doma',                         turkish: 'Evdeyim',                             english: "I'm at home" },
  { id: 351, tab: 'temel', russian: 'В каком ты городе?',       pronunciation: 'V kakom tı gorode?',              turkish: 'Hangi şehirdesin?',                   english: 'What city are you in?' },
  ...
  { id: 320, tab: 'sayilar', russian: 'восемнадцать',  pronunciation: 'vosemnadtsat',  turkish: 'on sekiz',  english: '18' },
  { id: 321, tab: 'sayilar', russian: 'девятнадцать',  pronunciation: 'devyatnadtsat', turkish: 'on dokuz',  english: '19' },
  { id: 322, tab: 'sayilar', russian: 'двадцать',      pronunciation: 'dvadtsat',      turkish: 'yirmi',     english: '20' },
